...
1. Copy the repository or simply download the 'hash_word.c' file.
...
3. In MSYS2 or PowerShell (if environmental variables of your OS are configured to work with MSYS2), navigate to the repo directory or a directory where 'hash_word.c' is stored.
